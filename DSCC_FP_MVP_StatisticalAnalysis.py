...
def statistical_data(stock_data, symbol):
    ...
    df = pd.DataFrame([mean, std_dev, min, max, range, median, variance], index=["Mean", "Standard Deviation", "Min", "Max", "Range", "Median", "Variance"])
    df_additional = pd.DataFrame([num_of_trading_days, num_of_profit_days, num_of_loss_days], index=["Number of Trading Days in 2021", "Number of profit days", "Number of loss days"])
